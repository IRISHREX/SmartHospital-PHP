...
class Chat extends Patient_Controller {
   public $patient_data;
    ...
    public function searchuser() {
        ...
        $userlist = $this->load->view('patient/chat/_partialSearchUser', $data, true);
        $array = array('status' => '1', 'error' => '', 'page' => $userlist);
    ...
    public function adduser() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            } elseif (strtolower($user_type) == "staff") {
            ...
            if(isset($new_user->image) && $new_user->image!=null){
                $new_user->image= $this->media_storage->getImageURL('uploads/staff_images/'.$new_user->image);
            }else{
                $new_user->image=$this->media_storage->getImageURL('uploads/staff_images/no_image.png');
            }
