   ...
   public function index()
    {
        ...
        $payment_amount_including_processing_fee   =   ($total+$gateway_processing_charge);//added
        $this->session->set_userdata('payment_amount_including_processing_fee', $payment_amount_including_processing_fee);//added
        //processing fees added
    ...
    public function pay() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $payment_data['amount'] =$data['amount'];//added charge+processing fees
