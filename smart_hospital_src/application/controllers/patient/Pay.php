        ...
        if ($this->form_validation->run() == false) {
            ...
            $array = array('status' => 'fail', 'error' => $msg);
                ...
                if($charge_type=='percentage'){
                    $gateway_processing_charge=(($payment_data["deposit_amount"] * $charge_value)/100);
                }elseif($charge_type=='fix'){
                    $gateway_processing_charge=$charge_value;
                }else{
                    $gateway_processing_charge=0;   
                }   
                $payment_data['charge_type']                = $charge_type;
                $payment_data['gateway_processing_charge']  = $gateway_processing_charge;
                //processing fees added
